 ...
 */
final class Version20250408105914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE book ADD COLUMN book_cover VARCHAR(255) DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, book_editor_id INTEGER NOT NULL, category_id INTEGER NOT NULL, book_author_id INTEGER NOT NULL, book_title VARCHAR(255) NOT NULL, book_summary CLOB NOT NULL, book_isbn INTEGER NOT NULL, CONSTRAINT FK_CBE5A3317B3BBA0A FOREIGN KEY (book_editor_id) REFERENCES editor (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CBE5A33112469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CBE5A331E4DBE55D FOREIGN KEY (book_author_id) REFERENCES author (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
